...
shields = []
shields.append(battle.Shield(name="wickedshield", squer=0.9, resource=5))
shields.append(battle.Shield(name="skeenshield", squer=0.7, resource=20))
shields.append(battle.Shield(name="armshield", squer=0.1, resource=100))
shields.append(battle.Shield(name="bronzeshield", squer=0.4, resource=250))
shields.append(battle.Shield(name="woodshield", squer=0.4, resource=100))
shields.append(battle.Shield(name="steelshield", squer=0.4, resource=300))
shields.append(battle.Shield(name="dropshield", squer=0.7, resource=300))

formations = []
formations.append(battle.Sparse())
formations.append(battle.Wawes())
formations.append(battle.Persian())
formations.append(battle.Squer())
formations.append(battle.Phalanx())
formations.append(battle.LinedPhalanx())
formations.append(battle.Tortue())
formations.append(battle.Wedge())
