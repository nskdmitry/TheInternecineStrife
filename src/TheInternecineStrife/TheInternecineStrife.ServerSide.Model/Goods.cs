    ...
    public class Good
    {
        ...
        static Good()
        {
        	Resources = new List<Good> {
        		...
        		new Good( 4, "кремень", 2.3f, GoodClass.Source),
        		new Good( 5, "камень", 0.9f, GoodClass.Source),
        		new Good( 6, "каменный нож", 4.2f, GoodClass.Item),
        		new Good( 7, "шкура-плащ", 4.2f, GoodClass.Item),
        		new Good( 8, "кол", 2.4f, GoodClass.Item),
