...
, _("Midieval"), _("Industrial"), _("File opening time error"), _("Error: file {}.feods not found in defined folders."), _("Please wait: our generator make a new map at foreground process..."), _("New"), _("Rename mark"), _("Enter new name of mark (old: {})"), _("Draw"), _("Wand")
]
